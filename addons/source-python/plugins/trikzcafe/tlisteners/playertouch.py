...
def start_touch_func(args):
    ...
    if is_player_above >= 0.0 and not p_up.skyboost and not p_up.is_grounded and not p_down.on_ground:
        if not p_up.ducking and p_down.velocity.z > 0.0 and not p_up.boost_step > 0:
